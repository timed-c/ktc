...
#line 108 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
struct cbm {
   int use ;
   int data ;
   struct cbm *nextc ;
...
#line 124 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
struct fifolist {
   int data ;
   struct timespec ts ;
...
cbm cabmsgv  ;
#line 122 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
struct cab_ds cabdsv  ;
#line 149 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
struct sched_attr sae  ;
#line 150 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
...
struct option o  ;
#line 165 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
...
#line 225 "/home/saranya/Dokument/ktc/bin/../include/cilktc.h"
...
#line 46
    if (tc.rx_length != 0) {
      {
      ktc_fifo_write(& tcChan, & tcChanktclist, & tcChanktccount, & tcChanktctail, & tc, sizeof(tc));
      }
    }
    {
    {
...
#line 61
    printTrace();
#line 62
    tmp = nelem(& tcChan, tcChanktctail, tcChanktccount);
#line 62
    if (tmp != 0) {
#line 62
      goto _L;
...
#line 69
    ...
    {
#line 70
    ktc_sdelay_init(tctime - t, tctime - t, 0, & start_time, 14);
    _110: /* CIL Label */ ;
    }
    }
    if (setschedvar) {
...
{ 
  ...
  {
  {
  ktc_sdelay_init(-1404, -1404, 0, & start_time, 16);
  _125: /* CIL Label */ ;
  }
  }
  taskid = "main";
