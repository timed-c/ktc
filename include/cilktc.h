...
extern long ktc_sdelay_init(int intrval, char* unit, struct timespec* start_time ) ;
extern long ktc_fdelay_init(int intrval, char* unit, struct timespec* start_time ) ;
