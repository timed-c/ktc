...
ktcoption:
	@ocamlbuild  -no-hygiene  -cflags '-w -a' -use-ocamlfind -package cil -Is $(DIRS) ktcoptions.cma > log
	@ocamlbuild  -no-hygiene -cflags '-w -a' -use-ocamlfind -package cil -Is $(DIRS) ktcoptions.cmxa > log
	@ocamlbuild  -no-hygiene -cflags '-w -a' -use-ocamlfind -package cil -Is $(DIRS) cilktc.cma > log
	@ocamlbuild  -no-hygiene -cflags '-w -a' -use-ocamlfind -package cil -Is $(DIRS) cilktc.cmxa 
	@rm -f bytes.ml
...
native:
	@ocamlbuild -no-hygiene -cflags '-w -a' -use-ocamlfind -package cil  -Is $(DIRS) main.native 
	@rm -f main.native 
